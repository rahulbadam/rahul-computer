...
function generateProdHtml (env) {
    ...
    h += '    gui_origin: window.location.origin,';
    h += '    title: "Puter",';
    h += '    max_item_name_length: 150,';
    h += '    require_email_verification_to_publish_website: false,';
    h += '    short_description: "Puter is a privacy-first personal cloud that houses all your files, apps, and games in one private and secure place, accessible from anywhere at any time."';
    h += '  });';
    h += '};';
    h += '</script>';
    h += '</body>';
