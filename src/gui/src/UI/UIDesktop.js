...
async function UIDesktop (options) {
    ...
    // github
    ht += `<a href="https://github.com/rahulbadam/rahul-computer" target="_blank" class="toolbar-btn" title="${i18n('toolbar.github')}" style="background-image:url(${window.icons['logo-github-white.svg']});"></a>`;
    ...
    // i.e. https://rahulbadam.github.io/app/<app_name>
    //--------------------------------------------------------------------------------------
    if ( window.url_paths[0]?.toLocaleLowerCase() === 'app' && window.url_paths[1] ) {
    ...
    // i.e. https://rahulbadam.github.io/@<username>
    //--------------------------------------------------------------------------------------
    ...
    // i.e. https://rahulbadam.github.io/?download=<file_url>
    //--------------------------------------------------------------------------------------
